...
// InsertReservation inserts reservation to databse
...
// InsertRoomRestriction inserts room restriction into database
...
// SearchAvailabitilyByDatesByRomID returns true if availability exists for roomID, and false if no availability
...
func (m *postgresDBRepo) GetRestrictionsForRoomByDate(roomID int, start, end time.Time) ([]models.RoomRestriction, error) {
	...
	// coalesce: if has reservation_id it returns reservation_id else it return 0 (as we cannot pass reservation_id null to next loop as it is int)
