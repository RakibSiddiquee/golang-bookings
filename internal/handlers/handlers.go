...
import (
	...
	"github.com/RakibSiddiquee/bookings/internal/driver"
	"github.com/RakibSiddiquee/bookings/internal/forms"
	...
	"github.com/RakibSiddiquee/bookings/internal/repository"
	"github.com/RakibSiddiquee/bookings/internal/repository/dbrepo"
...
func (m *Repository) PostReservation(w http.ResponseWriter, r *http.Request) {
	...
	htmlMessage := fmt.Sprintf(`
		...
		Dear %s: <br>
		This is the confirmation of your reservation from %s to %s.
...
func (m *Repository) AdminReservationsCalendar(w http.ResponseWriter, r *http.Request) {
	...
	for _, x := range rooms {
		...
		// get all the restrictions for the current page
...
func (m *Repository) AdminPostReservationsCalendar(w http.ResponseWriter, r *http.Request) {
	...
	for _, x := range rooms {
		...
		curMap := m.App.Session.Get(r.Context(), fmt.Sprintf("block_map_%d", x.ID)).(map[string]int) // (map[string]int) is used to cast
